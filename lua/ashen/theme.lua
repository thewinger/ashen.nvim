...
M.map = {
  ...
  -- AshenRedKindling = { c.red_kindling },
  -- AshenRedBurntCrimson = { c.red_burnt_crimson },
  -- AshenRedBrick = { c.red_brick },
  -- AshenRedDeepEmber = { c.red_deep_ember },
  -- AshenRedAshen = { c.red_ashen },
