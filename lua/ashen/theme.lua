...
M.map = {
  ...
  Directory = { c.g_3, nil },
  DiffAdd = { c.g_4, c.g_8 },
  DiffChange = { c.orange_smolder, c.g_6 },
  DiffDelete = { c.red_ember, c.g_8 },
  ...
  WarningMsg = { c.orange_golden, nil },
  ...
  ["@punctuation.special"] = { c.orange_golden, nil },
  ["@repeat"] = { c.g_2, nil },
  ...
  ["@tag"] = { c.g_5, nil },
  ["@diff.plus"] = { c.g_4, nil },
  ["@diff.minus"] = { c.red_ember, nil },
  ["@diff.delta"] = { c.orange_smolder, nil },
