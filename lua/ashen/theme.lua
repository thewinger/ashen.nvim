...
local map = {
  ...
  DiagnosticUnderlineError = { nil, nil, { underline = true, sp = c.red_flame } },
  DiagnosticUnderlineWarn = { nil, nil, { underline = true, sp = c.orange_golden } },
  DiagnosticUnderlineOk = { nil, nil, { underline = true, sp = c.green } },
  DiagnosticUnderlineInfo = { nil, nil, { underline = true, sp = c.blue } },
  DiagnosticUnderlineHint = { nil, nil, { underline = true, sp = c.g_3 } },
